# DynamoDB table for account public data
# Simple table with PK/SK for multi-account data storage
# Naming: account-admin-public-{workspace} (e.g., account-admin-public-uat)
resource "aws_dynamodb_table" "account_public" {
  ...
  tags = merge(var.common_tags, {
    Name        = "account-admin-public-${var.environment}"
    Purpose     = "Multi-Account Public Data"
