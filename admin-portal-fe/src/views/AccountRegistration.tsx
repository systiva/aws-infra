...
import { AccountRegistrationRequest } from '../models/AccountModel';
...
export const AccountRegistration: React.FC = () => {
  ...
  const [registrationData, setRegistrationData] = useState<AccountRegistrationRequest>({
    accountName: '',
    email: '',
  ...
  const handleFieldChange = (field: keyof AccountRegistrationRequest, value: string) => {
  ...
  const submitRegistration = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await apiClient.registerAccount(requestData);
      alert(`Account registration successful! Account ID: ${result.accountId}`);
      navigate('/directory');
    } catch (error) {
      ...
      <div className="registration-card">
        <form onSubmit={submitRegistration}>
          ...
          <div className="admin-section">
            ...
            <p className="admin-info">These details will be used to create the account administrator account.</p>
            ...
            <div className="form-section">
              ...
              <small className="field-hint">This will be the admin user's login email (can be different from account contact email)</small>
            </div>
